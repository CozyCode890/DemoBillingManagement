#!/bin/bash
# =====================================================================
#  sql-drop-db.sh -- Xóa sạch database retail_billing
# =====================================================================
...
echo -e "${YELLOW}Dang xoa database retail_billing...${NC}"
export MYSQL_PWD="$PW"

mysql -u "$USER" -h 127.0.0.1 -P 3306 -e "DROP DATABASE IF EXISTS retail_billing;"

unset MYSQL_PWD
echo -e "${GREEN}[OK] Da xoa sach database retail_billing.${NC}"
